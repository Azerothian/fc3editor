...
namespace Nomad
{
	public unsafe static class Binding
	{
		...
		public delegate bool DllMain(IntPtr handle, uint reason, IntPtr reserved);

		public static bool _dllBypass(IntPtr handle, uint reason, IntPtr reserved)
		{
			return true;
		}
		...
		//public delegate bool DisableThreadLibraryCallsDelegate(IntPtr hModule);
		//public static bool DisableThreadLibraryCalls(IntPtr handle)
		//{
		//	return true;
		//}
		...
		public static void Initialise()
		{
			...
			//var hModule = LocalHook.GetProcAddress( Binding.gameDll, "DllEntryPoint");

			//IntPtr ptr = new IntPtr(0);
			IntPtr hModule = Binding.LoadLibrary(Binding.engineDll);


			//IntPtr module = Binding.GetModuleHandle(Binding.engineDll);

			//var result = EasyHook.LocalHook.Create(LocalHook.GetProcAddress("kernel32.dll", "DisableThreadLibraryCalls"), new DisableThreadLibraryCallsDelegate(DisableThreadLibraryCalls), o);
		...
		//	LoadLibraryEx(
			...
			//var hook = new IntPtr(
			//					  0x10DF2F04 +
			//					  Marshal.ReadInt32(hModule));

			//var original = (DllMain)Marshal.GetDelegateForFunctionPointer(hook, typeof(DllMain));

			//var __dllmain =  int.Parse("10DF2F04", System.Globalization.NumberStyles.HexNumber);
			//	IntPtr hook = new IntPtr(__dllmain + (int)hModule);


			//var result = EasyHook.LocalHook.Create(hook, new DllMain(_dllBypass), o);
			//result.ThreadACL.SetExclusiveACL(new Int32[0]);
