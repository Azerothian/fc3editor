...
namespace Nomad
{
	public class ViewportControl : UserControl
	{
		...
		private void ViewportControl_MouseEnter(object sender, EventArgs e)
		{
			...
			// TODO:Editor OnMouseEvent Input?
			//Editor.OnMouseEvent(MouseEvent.MouseEnter, null);
		}
		...
		public void UpdateSize()
		{
			...
			Engine.Instance.UpdateResolution(clientSize);
		}
		...
		private void UpdateCameraState()
		{
			...
			if (Engine.Instance.ConsoleOpened || !this.Focused)
			{
				this.ResetCameraState();
				return;
			}
