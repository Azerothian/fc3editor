...
ATTENTION: 
    ...
    This file is an exception. You may use it in any proprietary software,
    even if it belongs to the EasyHook source code. This exception was made,
    to allow convenient access to the native API. Keep in mind that any other
    source code file mustn't be used in any non-(L)GPL project! 
